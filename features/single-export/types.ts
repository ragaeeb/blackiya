...
export type SingleExportDeps = {
    ...
    /** Returns a terminal response previously observed while the page loaded. */
    getCachedConversation?: (platformName: string, conversationId: string) => ConversationData | undefined;
