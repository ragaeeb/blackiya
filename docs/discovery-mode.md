...
2. Run the analyzer:
   - `bun run har:analyze --input logs/grok.com.har --host grok.com --host grok.x.com --hint "Agents thinking" --hint "I have the full text broken into segments P101391 to P101395a."`
...
- `--host` is repeatable; useful for mixed captures (e.g., `grok.com` + `grok.x.com`).
